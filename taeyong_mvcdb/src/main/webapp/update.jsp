...
<%@ page import="kpu.web.club.domain.*, java.util.List"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<body>
	...
	<HR>
	<form action="http://localhost:8080/taeyong_mvcdb/StudentServlet?cmd=update" method="post">
		<%
		...
		<fieldset>
			...
			<ul>
				...
				<li>USERNAME : <input type="text" name="username" value= <%=student.getUsername()%> readonly></li>
